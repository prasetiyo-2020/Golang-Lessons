...
func main() {
	...
	fmt.Printf("%s %s %s %s %s %s", firstName, "memberi hadiah", gift, "kepada", objectFirstName, "untuk belajar pemrograman")
}
```
```
$ go run .
Prasetiyo memberi hadiah Laptop kepada Diana untuk belajar pemrograman
```
