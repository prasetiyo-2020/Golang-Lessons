...
func main() {
	...
	pertanyaan(kodeSpesial)
	pertanyaan("mmwk7a")
	pertanyaan("jzkywth1")
}

func pertanyaan(question string) {
	var input string
	fmt.Printf("Ketik kode berikut : %s \n", question)
	fmt.Scan(&input)
...
```
$ go run .
> Ketik kode berikut : facelessvoid 
= facelessvoid
> facelessvoid telah dimasukkan 
> ---------------------------------------
> Ketik kode berikut : mmwk7a
= mmwk7a
> mmwk7a telah dimasukkan
> ---------------------------------------
> Ketik kode berikut : jzkywth1
= jzkywth1
